...
namespace APITests
{
    ...
    class MenuTests
    {
        ...
        public void GetMenuTest()
        {
            ...
            Assert.That(actualApplicant.probityStatementExists.Equals(false));
            Assert.That(actualApplicant.professionalIndemnityInsurancesExists.Equals(false));
            Assert.That(actualApplicant.professionalBehavioursExists.Equals(false));
            Assert.That(actualApplicant.revalidationExists.Equals(false));
            Assert.That(actualApplicant.operativeExposureExists.Equals(false));
            Assert.That(actualApplicant.clinicalOutcomesExists.Equals(false));
